...
const TRACKS: Record<string, Array<{ title: string; artist: string; duration: string }>> = {
  vitthal: [
...
const METADATA: Record<string, { title: string; god: string; color: string; img: string }> = {
...
export function GodBhajanClient({ god }: { god: string }) {
  const [playing, setPlaying] = useState<number | null>(null);
  
  const godId = (god || "vitthal").toLowerCase();
